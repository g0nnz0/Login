...
public class EditarUsuario extends javax.swing.JFrame {
    ...
    public EditarUsuario(ControladoraLogica controlLogic, int id_usuario) {
        initComponents();
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        controlLogic.editarUsuario(usu, usuario, contrasena, rol);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        //Una vez traemos los datos del usuario los asignamos a sus txtfield
        txtUsuario.setText(usu.getNombreUsuario());
        txtContrasena.setText(usu.getContrasena());

        //PARA CARGAR LOS ROLES ES MAS COMPLEJO
        //Cargar roles de forma generica previa a traer y setear el rol puntual del usuario a editar
        ...
        //Guardo en una variable la cantidad de items (roles) que tengo
        int cantidadItems = cmbRol.getItemCount();
        //Uso esa variable para recorrer los roles
        for (int i = 0; i < cantidadItems; i++) {
            if (String.valueOf(cmbRol.getItemAt(i)).equals(rol)) {
                //Fuerzo la seleccion del rol cuando encuentre un match
